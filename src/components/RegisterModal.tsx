        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full py-3 px-4 bg-white hover:bg-slate-50 border-2 border-slate-200 text-slate-800 font-bold rounded-2xl shadow-sm hover:shadow transition-all flex items-center justify-center gap-3 cursor-pointer disabled:opacity-50"
            >
